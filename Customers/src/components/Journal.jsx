    ...
    <>
      <style>{`
        ...
        * {
        ...
        .journal-page.dark-mode .journal-card:hover {
          border-color: #b99a6b;
          box-shadow: 0 12px 35px rgba(0, 0, 0, 0.4);
        }

        .journal-page.dark-mode .journal-name {
          color: #fdf8f0;
        }

        .journal-page.dark-mode .journal-description {
          color: rgba(253, 248, 240, 0.8);
        }

        .journal-page.dark-mode .quantity-btn {
          background: #2c2e43;
          border-color: #b99a6b;
          color: #b99a6b;
        }

        .journal-page.dark-mode .quantity-btn:hover {
          background: #b99a6b;
          color: #1a1b2a;
        }

        .journal-page.dark-mode .add-to-cart-btn {
          background: #c97b63;
        }

        .journal-page.dark-mode .add-to-cart-btn:hover {
          background: #d88c75;
        }

        .journal-page.dark-mode .wishlist-btn {
          border-color: #e07a5f;
          color: #e07a5f;
        }

        .journal-page.dark-mode .wishlist-btn:hover {
          background: #e07a5f;
          color: #1a1b2a;
        }

        .journal-page.dark-mode .back-btn:before {
          border-color: #fdf8f0;
        }

        .journal-page.dark-mode .back-btn:after {
          border-color: #b99a6b;
        }

        .journal-page.dark-mode .button-elem svg path {
          fill: #fdf8f0;
        }

        .journal-page.dark-mode .notification {
          background: #2c2e43;
          color: #fdf8f0;
        ...
        .journal-page.dark-mode .quantity-display {
          color: #fdf8f0;
        }
              ...
              <div key={journal.id} className="journal-card">
                ...
                <div className="journal-details">
                  ...
                  <div className="quantity-controls">
                    ...
                    <span className="quantity-display">{journal.quantity}</span>
                    <button
                      className="quantity-btn"
                      onClick={() => handleQuantityChange(journal.id, 1)}
                    >
